...
After a little reading and research on the topic and establishing my goals for the challenge, I set up my work environment. I used [Gatsby’s default] (https://www.gatsbyjs.org/starters/gatsbyjs/gatsby-starter-default/) started since it has dependencies I need already installed (and avoids me doing it). 
