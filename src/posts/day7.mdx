...
The layout.scss file would then be imported only once to the layout.js: import “../sass/layout.scss"
...
As always the [official documentation](https://www.styled-components.com/docs) is a useful starting point. For a brief introduction to styled components, there is also a [free 1-hour course](https://www.udemy.com/course/react-styled-components/) by Tom Phillips on Udemy. The course doesn’t cover all aspects of styled components but it provides a good bite-size overview. 
