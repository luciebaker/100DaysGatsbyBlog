...
Gatsby is known as a static site generator and it is indeed great for building static websites, but this is misleading; by that, I mean that Gatsby has much more to offer. As Jason Lengstor points out in his presentation titled [Beyond Static With Gatsby & Apollo]
(https://www.youtube.com/watch?v=wNUg1jpj9T0&feature=emb_rel_pause):
