...
I will set this research aside for now and over the next few days, refine the wireframe for my web app idea.  There are also some minor adjustments I want to make to my main site, as well as this [#100DaysofGatsby] (https://twitter.com/hashtag/100DaysofGatsby) blog page. Enough to keep me busy this the second challenge for #100days of Gatsby is announced! 
